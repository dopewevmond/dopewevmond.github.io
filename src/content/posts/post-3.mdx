---
title: Getting hired and retained as a non-cs person
slug: post-3
pubDate: 2024-11-19
author: 'Astro Learner'
description: Testing to see if the sorting on the archive page works
image:
  url: '/post-2.jpg'
...
```python
message = { summary: 'This is just some dummy text' }
print(message)
```
